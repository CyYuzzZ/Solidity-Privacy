...
std::map<std::string, Instruction> const solidity::evmasm::c_instructions =
{
	...
	{ "PDCV", Instruction::PDCV },
	{ "BPRV", Instruction::BPRV },
	{ "CANTRUST", Instruction::CANTRUST },
	{ "ISREGULATORY", Instruction::ISREGULATORY },
	{ "REGULAR", Instruction::REGULAR },
	{ "COMPARESTR", Instruction::COMPARESTR },
	{ "CONTAINSTR", Instruction::CONTAINSTR },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::PDCV,	{ "PDCV",		0, 2, 1, true, Tier::Special } },
	{ Instruction::BPRV,	{ "BPRV",		0, 2, 1, true, Tier::Special } },
	{ Instruction::CANTRUST,	{ "CANTRUST",		0, 1, 1, true, Tier::Special } },
	{ Instruction::ISREGULATORY,	{ "ISREGULATORY",		0, 1, 1, true, Tier::Special } },
	{ Instruction::REGULAR,	{ "REGULAR",		0, 2, 1, true, Tier::Special } },
	{ Instruction::COMPARESTR,	{ "COMPARESTR",		0, 2, 1, true, Tier::Special } },
	{ Instruction::CONTAINSTR,	{ "CONTAINSTR",		0, 2, 1, true, Tier::Special } },
